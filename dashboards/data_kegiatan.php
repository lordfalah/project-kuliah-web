<?php 
    ...
    if(isset($_POST["submit"])){
        ...
        if(isset($_POST["nameKegiatan"]) && isset($_POST["deskripsi"])){    
            $resultDataAdd = addDataAdmin($_POST, "user_kegiatan");
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="dashboard.php?dashboard=data_kegiatan" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="nameKegiatan">Nama Kegiatan</label>
                            <input required type="text" name="nameKegiatan" class="form-control" id="nameKegiatan"
                                aria-describedby="emailHelp">
                            <small id="emailHelp" class="form-text text-muted">We'll never share your kegiatan with
                                anyone
                                else.</small>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="deskripsi">Select image to upload:</label>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a
                                href=" update.php?id_update=<?php echo $data['id']; ?>&kegiatan=<?php echo $data['id']; ?>">
