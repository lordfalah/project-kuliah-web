...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-dark p-3">
        ...
        <div class="collapse navbar-collapse d-flex-md justify-content-end" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav  ">
                <li class="nav-item active">
                    <a class="nav-link text-white" href="pages/tentangKami.php">Tentang Kami <span
            ...
            <ul class="navbar-nav  ">
                <li class="nav-item active">
                    <a class="nav-link text-white" href="pages/organisasi.php">Organisasi <span
                            class="sr-only">(current)</span></a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav  ">
                <li class="nav-item active">
                    <a class="nav-link text-white" href="pages/kegiatan.php">Kegiatan <span
                            class="sr-only">(current)</span></a>
                </li>
            ...
            <ul class="navbar-nav  ">
                <li class="nav-item active">
                    <a class="nav-link text-white" href="pages/hubungiKami.php">Hubungi Kami <span
                            class="sr-only">(current)</span></a>
                </li>
            </ul>
